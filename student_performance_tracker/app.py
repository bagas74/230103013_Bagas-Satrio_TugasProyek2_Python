...
# --- FUNGSI BARU (Menu 7) ---
def menu_filter_nilai_rendah():
    """Tampilkan mahasiswa dengan nilai akhir < 70."""
    print("-- Filter: Mahasiswa dengan Nilai Akhir < 70 --")
    records = rekap_data.rekap()
    if not records:
        print("Belum ada data mahasiswa.")
        return
    ...
    # Filter data
    filtered_records = [r for r in records if r['nilai_akhir'] < 70]
...
def tampilkan_menu_utama():
    ...
    print("7) Filter nilai < 70")       # <-- DITAMBAHKAN
    print("8) Keluar")                  # <-- DIPERBARUI
